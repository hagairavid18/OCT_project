...
class CamExtractor():
    ...
    def forward_pass_on_convolutions(self, x):
        ...
        conv_output = None
        i= 0
        for module_pos, module in self.model.resnet._modules.items():
            # print('i {}, module {}'.format(i,module))
            if i== 9:
                break
...
if __name__ == '__main__':
    ...
    # Layer cam
    layer_cam = LayerCam(pretrained_model, target_layer=3)
    # Generate cam mask
